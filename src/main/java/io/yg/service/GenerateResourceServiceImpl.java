...
public class GenerateResourceServiceImpl implements GenerateResourceService {
    ...
    public void generateIndex() {
        try {
            ...
            for (Article article : articles) {
                ...
                tmp += tmp01 + "/" + article.getName().split("\\.")[0] + ".html" + tmp02 + article.getName().split("\\.")[0].split("\\-")[1] + tmp03;
    ...
    public void execGenerate() {
        ...
        if (!gitDir.exists()) {
            ...
            String gitcloneMsg = ShellUtil.exceScript("git  clone " + commonConfig.getGiturl(), ShellUtil.LINUX);
        ...
        String gitMsg = ShellUtil.exceScript("git -C " + commonConfig.getGitpath() + " pull ", ShellUtil.LINUX);
